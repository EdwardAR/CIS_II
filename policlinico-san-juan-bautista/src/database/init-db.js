...
function initDatabase() {
  ...
  if (!adminExists) {
    ...
    const adminResult = insertUser.run('Administrador General', 'admin@policlinico.pe', defaultPasswordHash, 'admin');
    const doctorUserResult = insertUser.run('Dra. Ana Torres', 'ana.torres@policlinico.pe', defaultPasswordHash, 'medico');
    ...
    console.log(`Admin ID creado: ${adminResult.lastInsertRowid}`);
  }
}
